            ...
            {id === 6 && (
              <div className="mt-5 reletive">
                <div className="absolute bottom-5 right-0">
                  ...
                  <MagicButton title={copied ? "Email Copied" : "Copy My Email"} icons={ <IoCopyOutline /> } position={"left"} otherClasses="!bg-[#161a31]" handleClick={handleClick} />
