          ...
          <div className="flex justify-center relative z-10">
            <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
              <h1 className="font-bold text-4xl md:text-5xl text-center mb-3">
                My <span className="text-blue-500">Recent </span>Works
              </h1>
              <p className="text-center text-sm md:text-lg lg:text-xl">
                Here are a <span className="text-blue-500">few projects I&apos;ve worked </span>on recently
              </p>
            </div>
          </div>
        </div>
        <div className="flex flex-wrap items-center justify-center p-4 gap-16 mt-2 2xl:gap-28 2xl:p-20">
          {projects.map(({ id, title, desc, img, alt, iconsList, githublink, liveLink }) => (
            <div key={id}>
